...
const defaultTitle = 'Hap-Hisse Analiz Programı';
const defaultDescription =
  'Crema React Bootstrap is an React Bootstrap based admin template. buid with CRA and React Bootstrap library. ';
const defaultImage =
  ...
  const getMetaTags = (
    {
      ...
      tags = 'admin Template, admin Dashboard, CRA, Bootstrap, React Bootstrap, Modular SCSS , Create React App, Firebase, Aws Cognito, Jwt-Auth, Mail App, Todo App, ',
    },
    pathname,
  ) => {
